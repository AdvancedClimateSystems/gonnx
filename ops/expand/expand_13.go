...
// Expand13 represents the ONNX expand operator.
...
func (f *Expand13) Init(*onnx.NodeProto) error {
	return nil
}

// Apply applies the expand operator.
func (f *Expand13) Apply(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
	input := inputs[0]
...
func (f *Expand13) ValidateInputs(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
	return ops.ValidateInputs(f, inputs)
}

// GetMinInputs returns the minimum number of input tensors this operator expects.
func (f *Expand13) GetMinInputs() int {
	return MinExpand13Inputs
}

// GetMaxInputs returns the maximum number of input tensors this operator expects.
func (f *Expand13) GetMaxInputs() int {
	return MaxExpand13Inputs
}

// GetInputTypeConstraints returns a list. Every element represents a set of allowed tensor dtypes
// for the corresponding input tensor.
func (f *Expand13) GetInputTypeConstraints() [][]tensor.Dtype {
	return [][]tensor.Dtype{ops.AllTypes, {tensor.Int64}}
}

// String implements the stringer interface, and can be used to format errors or messages.
func (f *Expand13) String() string {
