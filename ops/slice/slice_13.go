...
// Slice13 represents the ONNX slice operator.
type Slice13 struct{}

// newSlice13 creates a new slice operator.
func newSlice13() ops.Operator {
	return &Slice13{}
}

// Init initializes the slice operator.
func (s *Slice13) Init(*onnx.NodeProto) error {
	return nil
}

// Apply applies the slice operator.
func (s *Slice13) Apply(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
	data := inputs[0]
...
func (s *Slice13) ValidateInputs(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
	return ops.ValidateInputs(s, inputs)
}

// GetMinInputs returns the minimum number of input tensors this operator expects.
func (s *Slice13) GetMinInputs() int {
	return MinSlice13Inputs
}

// GetMaxInputs returns the maximum number of input tensors this operator expects.
func (s *Slice13) GetMaxInputs() int {
	return MaxSlice13Inputs
}

// GetInputTypeConstraints returns a list. Every element represents a set of allowed tensor dtypes
// for the corresponding input tensor.
func (s *Slice13) GetInputTypeConstraints() [][]tensor.Dtype {
	return [][]tensor.Dtype{
		ops.AllTypes,
...
func (s *Slice13) String() string {
	return "slice13 operator"
}
...
func (s *Slice13) constructSlices(starts, ends, steps, axes []int, nTotalSlices int) []tensor.Slice {
...
func (s *Slice13) getDefaultAxes(nSlices int) []int {
...
func (s *Slice13) getDefaultSteps(nSlices int) []int {
