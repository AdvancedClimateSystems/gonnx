...
func TestUnsqueeze(t *testing.T) {
	tests := []struct {
		...
		{[]int16{1, 2, 3, 4, 5, 6, 7, 8}, []int{2, 2, 2},
			[]int64{0, 2, 4, 6}, []int{1, 2, 1, 2, 1, 2, 1}},

		{[]complex128{1, 2, 3, 4, 5, 6, 7, 8}, []int{2, 2, 2},
			[]int64{6, 0, 4, 2}, []int{1, 2, 1, 2, 1, 2, 1}},

		{[]float32{1, 2, 3, 4, 5, 6, 7, 8}, []int{2, 2, 2},
			[]int64{-7, -5, -3, -1}, []int{1, 2, 1, 2, 1, 2, 1}},

		{[]float32{1, 2, 3, 4, 5, 6, 7, 8}, []int{2, 2, 2},
			[]int64{-1, -7, -3, -5}, []int{1, 2, 1, 2, 1, 2, 1}},

		{[]float32{1, 2, 3, 4, 5, 6, 7, 8}, []int{2, 2, 2},
			[]int64{0, 1, 2, 3}, []int{1, 1, 1, 1, 2, 2, 2}},
	}
