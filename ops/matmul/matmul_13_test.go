...
func TestMatMul13Init(t *testing.T) {
	s := newMatMul13()
...
func TestInputValidationMatMul13(t *testing.T) {
	tests := []struct {
		inputs []tensor.Tensor
		err    error
	}{
		...
		},
		{
			...
			ops.ErrInvalidInputCount(1, &MatMul13{}),
		},
		{
			[]tensor.Tensor{
				ops.TensorWithBackingFixture([]int{1, 2}, 2),
			...
			ops.ErrInvalidInputType(0, "int", &MatMul13{}),
		},
	}
