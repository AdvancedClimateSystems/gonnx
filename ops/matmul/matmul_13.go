...
// MatMul13 represents the ONNX matmul operator.
type MatMul13 struct{}

// newMatMul13 returns a new MatMul13 operator.
func newMatMul13() ops.Operator {
	return &MatMul13{}
}

// Init initializes the matmul operator.
func (m *MatMul13) Init(*onnx.NodeProto) error {
	return nil
}

// Apply applies the matmul operator.
func (m *MatMul13) Apply(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
	A := inputs[0]
	B := inputs[1]
...
func (m *MatMul13) ValidateInputs(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
	return ops.ValidateInputs(m, inputs)
}

// GetMinInputs returns the minimum number of input tensors this operator expects.
func (m *MatMul13) GetMinInputs() int {
	return MinMatMul13Inputs
}

// GetMaxInputs returns the maximum number of input tensors this operator expects.
func (m *MatMul13) GetMaxInputs() int {
	return MaxMatMul13Inputs
}

// GetInputTypeConstraints returns a list. Every element represents a set of allowed tensor dtypes
// for the corresponding input tensor.
func (m *MatMul13) GetInputTypeConstraints() [][]tensor.Dtype {
	return [][]tensor.Dtype{
...
func (m *MatMul13) broadcastTensors(A, B tensor.Tensor) (tensor.Tensor, tensor.Tensor, error) {
...
func (m *MatMul13) batchedMatMul(A, B tensor.Tensor) (tensor.Tensor, error) {
	shapeA := A.Shape()
	shapeB := B.Shape()
...
// in the batchedMatMul13 operation. If the incrementing fails, false is returned.
