...
// BooleanOperator is a function that applies a boolena operator.
type BooleanOperator func(a, b bool) bool
...
func ApplyBooleanOperator(A, B tensor.Tensor, op BooleanOperator) (tensor.Tensor, error) {
