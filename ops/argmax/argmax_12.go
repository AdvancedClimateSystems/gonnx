...
// ArgMax12 represents the ONNX argmax operator.
type ArgMax12 struct {
	axis            int
	keepDims        bool
...
type ArgMax12Attribute string

// Init initializes the argmax operator.
func (a *ArgMax12) Init(n *onnx.NodeProto) error {
...
func (a *ArgMax12) Apply(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
...
func (a *ArgMax12) ValidateInputs(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
	return ops.ValidateInputs(a, inputs)
}

// GetMinInputs returns the minimum number of input tensors this operator expects.
func (a *ArgMax12) GetMinInputs() int {
	return MinArgMax12Inputs
}

// GetMaxInputs returns the maximum number of input tensors this operator expects.
func (a *ArgMax12) GetMaxInputs() int {
	return MaxArgMax12Inputs
}

// GetInputTypeConstraints returns a list. Every element represents a set of allowed tensor dtypes
// for the corresponding input tensor.
func (a *ArgMax12) GetInputTypeConstraints() [][]tensor.Dtype {
	return [][]tensor.Dtype{
...
func (a *ArgMax12) String() string {
	return "argmax12 operator"
}
