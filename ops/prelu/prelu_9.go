...
// PRelu9 represents the ONNX prelu operator.
type PRelu9 struct{}

// newPRelu9 creates a new prelu operator.
func newPRelu9() ops.Operator {
	return &PRelu9{}
}

// Init initializes the prelu operator.
func (op *PRelu9) Init(*onnx.NodeProto) error {
	return nil
}

// Apply applies the prelu operator.
func (op *PRelu9) Apply(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
	var err error
...
func (op *PRelu9) ValidateInputs(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
...
func (op *PRelu9) GetMinInputs() int {
	return PRelu9MinInputs
}

// GetMaxInputs returns the maximum number of input tensors this operator expects.
func (op *PRelu9) GetMaxInputs() int {
	return PRelu9MaxInputs
}

// GetInputTypeConstraints returns a list. Every element represents a set of allowed tensor dtypes
// for the corresponding input tensor.
func (op *PRelu9) GetInputTypeConstraints() [][]tensor.Dtype {
	return [][]tensor.Dtype{
...
func (op *PRelu9) String() string {
	return "prelu9 operator"
}
