...
func TestPRelu9Init(t *testing.T) {
	p := &PRelu9{}
...
func TestInputValidationPRelu9(t *testing.T) {
	tests := []struct {
		inputs []tensor.Tensor
		err    error
	}{
		...
		{
			[]tensor.Tensor{},
			ops.ErrInvalidInputCount(0, &PRelu9{}),
		},
		{
			[]tensor.Tensor{
			...
			ops.ErrInvalidInputType(0, "int", &PRelu9{}),
		},
	}
...
func BenchmarkPRelu9_Apply(b *testing.B) {
	prelu := &PRelu9{}
