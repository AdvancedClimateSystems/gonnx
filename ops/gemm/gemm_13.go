...
// Gemm13 represents the ONNX gemm operator.
type Gemm13 struct {
	alpha  float32
	beta   float32
	transA bool
...
// newGemm13 creates a new gemm operator and initializes it with the default values.
...
// Init initializes the Gemm13 operator based on the ModelProto attributes.
...
func (g *Gemm13) Apply(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
	var err error
...
func (g *Gemm13) ValidateInputs(inputs []tensor.Tensor) ([]tensor.Tensor, error) {
	return ops.ValidateInputs(g, inputs)
}

// GetMinInputs returns the minimum number of input tensors this operator expects.
func (g *Gemm13) GetMinInputs() int {
	return MinGemm13Inputs
}

// GetMaxInputs returns the maximum number of input tensors this operator expects.
func (g *Gemm13) GetMaxInputs() int {
	return MaxGemm13Inputs
}

// GetInputTypeConstraints returns a list. Every element represents a set of allowed tensor dtypes
// for the corresponding input tensor.
func (g *Gemm13) GetInputTypeConstraints() [][]tensor.Dtype {
	return [][]tensor.Dtype{
...
func (g *Gemm13) String() string {
	return "gemm13 operator"
}
