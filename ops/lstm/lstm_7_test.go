...
func TestLSTM7Init(t *testing.T) {
	lstm := &LSTM7{}
	err := lstm.Init(LSTM7OnnxNodeProtoFixture())
...
func TestLSTM7InitUnkownAttr(t *testing.T) {
	lstm := LSTM7{}
	tests := []struct {
...
func TestInputValidationLSTM7(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			nil,
			ops.ErrInvalidOptionalInputCount(1, &LSTM7{}),
		},
		{
			[]tensor.Tensor{
				ops.TensorWithBackingFixture([]float32{1, 2}, 2),
			...
			nil,
			ops.ErrInvalidInputType(1, "int", &LSTM7{}),
		},
		{
			[]tensor.Tensor{
				ops.TensorWithBackingFixture([]int{1, 2}, 2),
			...
			nil,
			ops.ErrInvalidInputType(0, "int", &LSTM7{}),
		},
		{
			[]tensor.Tensor{
				ops.TensorWithBackingFixture([]float32{1, 2}, 2),
			...
			nil,
			ops.ErrInvalidInputType(2, "int", &LSTM7{}),
		},
		{
			[]tensor.Tensor{
				ops.TensorWithBackingFixture([]float32{1, 2}, 2),
			...
			nil,
			ops.ErrInvalidInputType(3, "int", &LSTM7{}),
		},
		{
			[]tensor.Tensor{
				ops.TensorWithBackingFixture([]float32{1, 2}, 2),
			...
			nil,
			ops.ErrInvalidInputType(4, "float32", &LSTM7{}),
		},
		{
			[]tensor.Tensor{
				ops.TensorWithBackingFixture([]float32{1, 2}, 2),
			...
			nil,
			ops.ErrInvalidInputType(5, "int", &LSTM7{}),
		},
		{
			[]tensor.Tensor{
				ops.TensorWithBackingFixture([]float32{1, 2}, 2),
			...
			nil,
			ops.ErrInvalidInputType(6, "int", &LSTM7{}),
		},
		{
			[]tensor.Tensor{
				ops.TensorWithBackingFixture([]float32{1, 2}, 2),
			...
			nil,
			ops.ErrInvalidInputType(7, "int", &LSTM7{}),
		},
	}
...
func LSTM7OnnxNodeProtoFixture() *onnx.NodeProto {
